...
public class MyDataTestController {
	...
	public String testData2() throws IOException {
		...
		String result = get1005("20221123");
	...
	public String get1005(String date) {
		return "{\n"
			+ "\"errCode\":\"0000\",\n"
			+ "\"errMsg\":\"success\",\n"
			+ "\"result\":\"SUCCESS\",\n"
			...
			+ "{\n"
			+ "\"TREATTYPE\":\"약국\",\n"
			+ "\"MEDICINENM\":\"텍스톤캡슐55mg (TEXTON CAP)\",\n" //텍스톤캡슐75mg (TEXTON CAP)
			+ "\"TREATDATE\": \"" + date + "\",\n"
			+ "\"DRUGINFOLIST\":[\n"
			+ "{\n"
			+ "\"DUR\":[\n"
			...
			+ "\"PRODUCTNM\":\"텍스톤캡슐55mg TEXTON CAP\",\n"
			...
			+ "\"INGREDIENTNMLIST\":[\n"
			+ "{\n"
			+ "\"INGREDIENTNM\":\"텍스톤아세테이트염산염(Texton Acetate Hydrochloride)mg\"\n"
			+ "}\n"
			+ "]\n"
			+ "}\n"
			+ "],\n"
			...
			+ "],\n"
			+ "\"MAKINGCOMPANY\":\"팜젠사이언스\",\n"
			+ "\"PRODUCTNM\":\"테네시정 TESA TAB.\",\n"
			+ "\"MEDICINEGROUP\":\"진경제(124)\",\n"
			+ "\"SALESCOMPANY\":\"\",\n"
			+ "\"KPICLIST\":[\n"
			+ "{\n"
			+ "\"KPIC\":\"테네시정염산염(Tesa Hydrochloride) : 소화기계질환< 진경제<기타\"\n"
			+ "}\n"
			+ "],\n"
