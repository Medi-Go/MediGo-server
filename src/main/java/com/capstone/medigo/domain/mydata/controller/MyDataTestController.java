...
public class MyDataTestController {
	...
	public String testData() throws IOException {
		...
		String result = getResult("20221202");
	...
	public String testData2() throws IOException {
		...
		String result = get1005("20221212");
	...
	public String get1005(String date) {
		return "{\n"
			...
			+ "               {\n"
			+ "                  \"TREATTYPE\":\"약국\",\n"
			+ "                  \"MEDICINENM\":\"톡시톡신캡슐55mg (TOXITOXIN CAP)\",\n"
			+ "        \"TREATDATE\": \"" + date + "\",\n"
			+ "                  \"DRUGINFOLIST\":[\n"
			+ "                     {\n"
			+ "                        \"DUR\":[\n"
			...
			+ "                        \"PRODUCTNM\":\"톡시톡신캡슐55mg TOXITOXIN CAP\",\n"
			...
			+ "                        \"INGREDIENTNMLIST\":[\n"
			+ "                           {\n"
			+ "                              \"INGREDIENTNM\":\"톡시톡신아세테이트염산염(Toxitidine Acetate Hydrochloride)mg\"\n"
			+ "                           }\n"
			+ "                        ]\n"
			+ "                     }\n"
			+ "                  ],\n"
